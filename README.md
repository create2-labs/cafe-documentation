...
- [ADR — CPM catalog facts / FE boundary (ADR_20260918)](https://github.com/create2-labs/cafe-adr/blob/main/ADR_20260918_cpm_catalog_facts_frontend_boundary.md) — CPM certifies catalogue/explore/persist facts (incl. catalog provider table, greenfield explore, multi-chain snapshot); product FE does not mirror providers or join `GET /providers`; [PR plan CFB-\*](https://github.com/create2-labs/cafe-adr/blob/main/ADR_20260918_cpm_catalog_facts_frontend_boundary_PR_PLAN.md) (**CFB-P17** docs train P9+).
